...
export const metadata: Metadata = {
  title: "Investment Projects | Diamond Capital Africa",
  description:
    "Browse Uganda Investment Authority bankable projects aligned with DCA's institutional capital deployment framework.",
};
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="mb-8 max-w-3xl">
            ...
            <p className="mt-3 text-base leading-relaxed text-white/50">
              ...
              Uganda&apos;s highest-yield sectors before requesting a confidential
              DCA investment brief.
            </p>
