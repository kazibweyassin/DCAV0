  ...
  return (
    <section className="relative min-h-screen overflow-hidden">
      ...
      <div className="relative mx-auto flex min-h-screen max-w-7xl flex-col justify-center px-6 pb-24 pt-32 lg:px-8">
        ...
        <div className="mt-16 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {TRUST_BADGES.map((badge) => {
            ...
            return (
              <div
                key={badge.id}
                className="group flex items-start gap-3 rounded-lg border border-white/[0.06] bg-obsidian/40 p-4 backdrop-blur-sm transition-all hover:border-emerald/30 hover:bg-emerald/5"
              >
        ...
        <div className="mt-12 flex flex-wrap items-center gap-6 border-t border-white/[0.06] pt-8 sm:gap-8">
          <div>
